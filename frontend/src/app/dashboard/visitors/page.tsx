      ...
      <main className="max-w-7xl mx-auto px-6 mt-8">
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-6 py-5 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
            <div>
              <h3 className="font-bold text-slate-800 text-lg">Visitor Logs</h3>
              <p className="text-slate-500 text-xs">All successful check-ins from visitor entry passes.</p>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-20 text-slate-500 space-y-4">
              ...
              <div>
                <h4 className="text-slate-800 font-bold">No Visitor Logs</h4>
                <p className="text-slate-500 text-sm mt-1">No visitors have checked in yet.</p>
              </div>
            </div>
          ) : (
